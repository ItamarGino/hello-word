...
void DFA_test()
{
	...
	cout << dfa1.isBelong(wordInLanguage) << "\n";
	cout << dfa1.isBelong(wordNotInLanguage) << "\n";
	cout << dfa2.isBelong(wordInLanguage) << "\n";
	cout << dfa2.isBelong(wordNotInLanguage) << "\n";
